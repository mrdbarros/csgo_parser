SELECT PLAYER.idPLAYER AS ID_PLAYER,PLAYER.NAME AS PLAYER_NAME,BASE_STATISTIC.NAME AS STATISTIC_NAME,SUM(STATISTICS_PLAYER_MATCH_FACT.VALUE)  AS VALUE
...
AND MONTH(CSGO_MATCH.MATCH_DATETIME)=4
...
SELECT PLAYER.idPLAYER, PLAYER.NAME,"Matches" AS STATISTIC_NAME,COUNT(DISTINCT(CSGO_MATCH.DEMO_FILE_HASH)) AS VALUE
	...
	WHERE PLAYER.idPLAYER IN (76561198096548700,76561197991587832,76561198150669181,76561198004120520,76561198064357864,76561198181838445,76561198262870608,76561197976402790,76561198010671936,76561198074906117,76561198091643952)
    AND MONTH(CSGO_MATCH.MATCH_DATETIME)=4
    GROUP BY PLAYER.idPLAYER,PLAYER.NAME,STATISTIC_NAME